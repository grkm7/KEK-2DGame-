...
public class SonucEkraniActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonTekrarDene = findViewById(R.id.buttonSkorlar);
        buttonSkorlar=findViewById(R.id.buttonSkorlar);
        ...
        buttonSkorlar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SonucEkraniActivity.this,ActivitySkor.class));
            }
        });
    }
}